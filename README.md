...
[ares-sc2 documentation](https://aressc2.github.io/ares-sc2/index.html)[ares-sc2 framework repo](https://github.com/AresSC2/ares-sc2)  
...
- [Poetry](https://python-poetry.org/) - [Python 3.11](https://www.python.org/downloads/release/python-3110/)

- [Git](https://git-scm.com/)- [Poetry](https://python-poetry.org/) 

- [Starcraft 2](https://starcraft2.com/en-gb/) - [Git](https://git-scm.com/)

- [Maps](https://sc2ai.net/wiki/maps/) Ensure maps are moved to the correct folder as suggested in this wiki.- [Starcraft 2](https://starcraft2.com/en-gb/) 
...
## Environment Setup for Linux (Lutris)The maps must be copied into the **root** of the Starcraft 2 maps folder - default location: `C:\Program Files (x86)\StarCraft II\Maps`.
...
export SC2PF=WineLinux```shell

export SC2PATH="/home/`(username)`/Games/battlenet/drive_c/Program Files (x86)/StarCraft II/"export SC2PF=WineLinux

export WINE="/home/`(username)`/.local/share/lutris/runners/wine/`(version of wine)`/bin/wine" export SC2PATH="/home/`(username)`/Games/battlenet/drive_c/Program Files (x86)/StarCraft II/"
...
git clone --recursive <your_git_repo_home_url_here>```bash
...
- Navigate to the path of the poetry environment from the terminal earlier, and select `Scripts/python.exe`- Select `Poetry Environment`, and choose `Existing Environment`
...
```basha: This means you're missing the ares-sc2 sub module 

git submodule update --init```bash

git submodule update --init --recursive --remotegit submodule update --init
...
--- 
***Interested in contributing*** to `ares-sc2`? Take a look at setting up a local dev environment [here instead.](https://aressc2.github.io/ares-sc2/contributing/index.html)
>>>>>>> ad6914201bb3081be028fb15ec38b93129b74baf
